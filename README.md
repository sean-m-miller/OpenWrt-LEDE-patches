...
These patches will never be mainlined into the official repositories, since they can only be applied to specific use cases, architectues, and versions. This will be discussed more in detail within the subdirectories.
